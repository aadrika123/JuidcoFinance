...
export const BillPaymentDetailsSchema = Yup.object().shape({
  ...
  payee_name_id: Yup.number().required("Payee Name is required"),
  vendor_name_id: Yup.number().required("Vendor Name is required"),
  ...
  other_deduction: Yup.number().required("Other Deduction is required"),
});
