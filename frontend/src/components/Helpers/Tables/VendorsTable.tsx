...
import { VendorsTableProps } from "@/components/VendorMaster/VendorList/VendorList";
          ...
          <tbody className="">
            {props.data?.map((d, index: number) => (
              <tr key={index} className="border border-zinc-400 text-secondary">
                ...
                {/* Name of Bank */}
                <td className="border border-zinc-400">{d?.vendor_type}</td>
                ...
                {/* Edit */}
                <td className="border border-zinc-400">
                  <Link href={`/vendor-master/edit/${d.id}`}>
                ...
                <td className="border border-zinc-400 ">
                  <div className="flex justify-center">
                    ...
                    <Link href={`/vendor-master/view/${d.id}`}>
                      <div className="flex justify-center opacity-90">
                        <span>
                          View
                        </span>
