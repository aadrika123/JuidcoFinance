          ...
          <tbody className="">
            {paymentEntryData?.map((d, index: number) => (
              <tr key={index} className="border border-zinc-400 text-secondary">
                ...
                {/* Payment No */}
                <td className="border border-zinc-400">{d?.payment_no}</td>

                {/*  Payment Name */}
                <td className="border border-zinc-400 ">
                  <div className="flex justify-center">{d?.payee_name}</div>
                </td>
