...
export const receiptRegisterDetailsSchema = Yup.object().shape({
  ...
  ulb_id: Yup.number().required("Ulb is required").notOneOf([-1], "Ulb is required."),
  primary_acc_code_id: Yup.number().required("Primary Acc Code is required").notOneOf([-1], "Primary Acc Code is required."),
  revenue_module_id: Yup.number().required("Revenue Module is required").notOneOf([-1], "Revenue Module is required."),
  ...
  revenue_accounted_type_id: Yup.number().required("Revenue Accounted is required.").notOneOf([-1], "Revenue Accounted is required."),
