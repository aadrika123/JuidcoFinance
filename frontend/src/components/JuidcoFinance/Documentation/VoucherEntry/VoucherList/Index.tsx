...
import VoucherEntryTable from "@/components/Helpers/Tables/VoucherTable";
...
const VoucherList: React.FC<VendorListProps> = (props) => {
  const { nextPage } = props;
  console.log(nextPage, "kavervk");
  return (
    <section className="border rounded-lg border-zinc-300 p-6 px-10">
      <div className="flex justify-between">
        <SubHeading>Voucher List</SubHeading>
        <SearchBox
