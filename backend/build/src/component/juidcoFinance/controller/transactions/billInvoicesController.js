...
const billInvoicesDao_1 = __importDefault(require("../../dao/transactions/billInvoicesDao"));
...
class BillInvoicesController {
    constructor() {
        ...
        this.create = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = billInvoicesValidation_1.billInvoicesValidation.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.billInvoicesDao.store(req);
        ...
        this.get = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const data = yield this.billInvoicesDao.get(req);
                if (!data)
        ...
        this.getById = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.billInvoicesDao.getById(id);
                if (!data)
                    return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).NOT_FOUND, data, resObj, res);
                return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).FOUND, data, resObj, res);
            }
        ...
        this.update = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = billInvoicesValidation_1.billInvoicesValidationWithID.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.billInvoicesDao.update(req);
        ...
        this.billInvoicesDao = new billInvoicesDao_1.default();
        this.initMesg = "Bill Invoices Entry";
    }
}
exports.default = BillInvoicesController;
