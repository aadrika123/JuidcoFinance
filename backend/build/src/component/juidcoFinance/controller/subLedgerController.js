...
const subledgerDao_1 = __importDefault(require("../dao/transactions/subledgerDao"));
...
class SubledgerController {
    constructor() {
        ...
        // Get limited subledgers
        this.getCodes = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            const resObj = {
                apiId,
                action: "GET",
                version: "1.0",
            ...
            try {
                const data = yield this.dao.getCodes();
                if (!data)
                    return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMsg).NOT_FOUND, data, resObj, res);
                return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMsg).FOUND, data, resObj, res);
            }
        ...
        this.dao = new subledgerDao_1.default();
        this.initMsg = "Subledgers";
    }
}
exports.default = SubledgerController;
