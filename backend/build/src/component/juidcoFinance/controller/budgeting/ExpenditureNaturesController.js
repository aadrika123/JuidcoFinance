...
const ExpenditureNaturesDao_1 = __importDefault(require("../../dao/budgeting/ExpenditureNaturesDao"));
...
class ExpenditureNaturesController {
    constructor() {
        ...
        this.dao = new ExpenditureNaturesDao_1.default();
        this.initMsg = "ExpenditureNatures";
    }
}
exports.default = ExpenditureNaturesController;
