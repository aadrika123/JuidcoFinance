...
const ReceiptBudgetsDao_1 = __importDefault(require("../../dao/budgeting/ReceiptBudgetsDao"));
...
class ReceiptBudgetsController {
    constructor() {
        ...
        this.create = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = receiptBudgetsValidation_1.receiptBudgetsValidation.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.receiptBudgetsDao.store(req);
        ...
        this.get = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const data = yield this.receiptBudgetsDao.get(req);
                if (!data)
        ...
        this.getById = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.receiptBudgetsDao.getById(id);
                if (!data)
                    return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).NOT_FOUND, data, resObj, res);
                return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).FOUND, data, resObj, res);
            }
        ...
        this.update = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = receiptBudgetsValidation_1.receiptBudgetsValidationWithID.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.receiptBudgetsDao.update(req);
        ...
        this.receiptBudgetsDao = new ReceiptBudgetsDao_1.default();
        this.initMesg = "ReceiptBudgets Entry";
    }
}
exports.default = ReceiptBudgetsController;
