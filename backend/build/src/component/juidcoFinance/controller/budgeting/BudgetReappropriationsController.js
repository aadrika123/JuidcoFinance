...
const BudgetReappropriationsDao_1 = __importDefault(require("../../dao/budgeting/BudgetReappropriationsDao"));
const budgetReappropriationsValidation_1 = require("../../requests/documentation/budgetReappropriationsValidation");
/**
 * | Author- Bijoy Paitandi
 * | Created for- BudgetReappropriations Controller
 * | Status: open
 */
class BudgetReappropriationsController {
    constructor() {
        // Create
        this.create = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = budgetReappropriationsValidation_1.budgetReappropriationsValidation.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.budgetReappropriationsDao.store(req);
        ...
        this.get = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const data = yield this.budgetReappropriationsDao.get(req);
                if (!data)
        ...
        this.getById = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.budgetReappropriationsDao.getById(id);
                if (!data)
                    return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).NOT_FOUND, data, resObj, res);
                return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).FOUND, data, resObj, res);
            }
        ...
        this.update = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = budgetReappropriationsValidation_1.budgetReappropriationsValidationWithID.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.budgetReappropriationsDao.update(req);
        ...
        this.budgetReappropriationsDao = new BudgetReappropriationsDao_1.default();
        this.initMesg = "BudgetReappropriations Entry";
    }
}
exports.default = BudgetReappropriationsController;
