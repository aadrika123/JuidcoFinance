...
const GrantEntriesDao_1 = __importDefault(require("../../dao/budgeting/GrantEntriesDao"));
...
class GrantEntriesController {
    constructor() {
        ...
        this.create = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = grantEntriesValidation_1.grantEntriesValidation.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.grantEntriesDao.store(req);
        ...
        this.get = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const data = yield this.grantEntriesDao.get(req);
                if (!data)
        ...
        this.getById = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.grantEntriesDao.getById(id);
                if (!data)
                    return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).NOT_FOUND, data, resObj, res);
                return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).FOUND, data, resObj, res);
            }
        ...
        this.update = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = grantEntriesValidation_1.grantEntriesValidationWithID.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.grantEntriesDao.update(req);
        ...
        this.grantEntriesDao = new GrantEntriesDao_1.default();
        this.initMesg = "GrantEntries Entry";
    }
}
exports.default = GrantEntriesController;
