...
const FinancialYearsDao_1 = __importDefault(require("../../dao/budgeting/FinancialYearsDao"));
/**
...
class FinancialYearsController {
    constructor() {
        ...
        this.dao = new FinancialYearsDao_1.default();
        this.initMsg = "FinancialYears";
    }
}
exports.default = FinancialYearsController;
