...
const BudgetAppropriationsDao_1 = __importDefault(require("../../dao/budgeting/BudgetAppropriationsDao"));
/**
...
class BudgetAppropriationsController {
    constructor() {
        ...
        this.create = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = budgetAppropriationsValidation_1.budgetAppropriationsValidation.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.budgetAppropriationsDao.store(req);
        ...
        this.get = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const data = yield this.budgetAppropriationsDao.get(req);
                if (!data)
        ...
        this.getById = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.budgetAppropriationsDao.getById(id);
                if (!data)
                    return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).NOT_FOUND, data, resObj, res);
                return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).FOUND, data, resObj, res);
            }
        ...
        this.update = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { error } = budgetAppropriationsValidation_1.budgetAppropriationsValidationWithID.validate(req.body);
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.budgetAppropriationsDao.update(req);
        ...
        // Get single biull invoice details by Id
        this.getCurrentAmounts = (req, res, apiId) => __awaiter(this, void 0, void 0, function* () {
            const resObj = {
                apiId,
                action: "GET",
                version: "1.0",
            ...
            try {
                ...
                if (error)
                    return commonResponse_1.default.VALIDATION_ERROR(error, resObj, res);
                const data = yield this.budgetAppropriationsDao.getCurrentAmounts();
                if (!data)
                    return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).NOT_FOUND, data, resObj, res);
                return commonResponse_1.default.SUCCESS((0, commonMessage_1.resMessage)(this.initMesg).FOUND, data, resObj, res);
            }
        ...
        this.budgetAppropriationsDao = new BudgetAppropriationsDao_1.default();
        this.initMesg = "BudgetAppropriations Entry";
    }
}
exports.default = BudgetAppropriationsController;
