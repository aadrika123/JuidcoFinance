...
const InvestmentTypesDao_1 = __importDefault(require("../../dao/budgeting/InvestmentTypesDao"));
...
class InvestmentTypesController {
    constructor() {
        ...
        this.dao = new InvestmentTypesDao_1.default();
        this.initMsg = "InvestmentTypes";
    }
}
exports.default = InvestmentTypesController;
