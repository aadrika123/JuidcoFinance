...
const bankMasterDao_1 = __importDefault(require("../../dao/masters/bankMasterDao"));
const bankMasterMessage_1 = __importDefault(require("../../responseMessage/masters/bankMasterMessage"));
/**
 * | Author- Sanjiv Kumar
    ...
    constructor() {
        ...
        this.get = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!data)
                    return (0, sendResponse_1.sendResponse)(true, bankMasterMessage_1.default.NOT_FOUND, data, 200, "GET", "0402", "1.0", res);
        ...
        this.getById = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!data)
                    return (0, sendResponse_1.sendResponse)(true, bankMasterMessage_1.default.NOT_FOUND, data, 200, "GET", "0403", "1.0", res);
        ...
        this.update = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { error } = bankMasterValidation_1.bankMasterUpdateValidation.validate(req.body);
                if (error)
