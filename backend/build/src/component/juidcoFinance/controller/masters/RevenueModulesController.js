...
const RevenueModulesDao_1 = __importDefault(require("../../dao/masters/RevenueModulesDao"));
/**
...
class RevenueModulesController {
    constructor() {
        ...
        this.dao = new RevenueModulesDao_1.default();
        this.initMsg = "RevenueModules";
    }
}
exports.default = RevenueModulesController;
