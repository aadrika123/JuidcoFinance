...
const ReceiptModesDao_1 = __importDefault(require("../../dao/masters/ReceiptModesDao"));
/**
 * | Author- Sanjiv Kumar
...
class ReceiptModesController {
    constructor() {
        ...
        this.dao = new ReceiptModesDao_1.default();
        this.initMsg = "ReceiptModes";
    }
}
exports.default = ReceiptModesController;
