...
const OpeningBalancesController_1 = __importDefault(require("../../controller/budgeting/OpeningBalancesController"));
/**
...
class OpeningBalancesRoute {
    constructor() {
        this.baseUrl = `${common_1.baseUrl}/opening-balances`;
        this.controller = new OpeningBalancesController_1.default();
    }
    configure(app, apiId) {
...
exports.default = OpeningBalancesRoute;
