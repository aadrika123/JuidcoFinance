...
const LoanManagementController_1 = __importDefault(require("../../controller/budgeting/LoanManagementController"));
/**
 * | Author- Sanjiv Kumar
...
class LoanManagementRoute {
    constructor() {
        this.baseUrl = `${common_1.baseUrl}/loan-management`;
        this.controller = new LoanManagementController_1.default();
    }
    configure(app, apiId) {
...
exports.default = LoanManagementRoute;
