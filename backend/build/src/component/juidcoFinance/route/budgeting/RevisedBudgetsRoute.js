...
const RevisedBudgetsController_1 = __importDefault(require("../../controller/budgeting/RevisedBudgetsController"));
/**
...
class RevisedBudgetsRoute {
    constructor() {
        this.baseUrl = `${common_1.baseUrl}/revised-budgets`;
        this.controller = new RevisedBudgetsController_1.default();
    }
    configure(app, apiId) {
...
exports.default = RevisedBudgetsRoute;
