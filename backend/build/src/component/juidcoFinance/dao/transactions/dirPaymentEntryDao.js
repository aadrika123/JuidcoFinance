...
const dirPaymentEntryValidation_1 = require("../../requests/transactions/dirPaymentEntryValidation");
const prisma = new client_1.PrismaClient();
class DirPaymentEntryDao {
    constructor() {
        // store payment entry details in DB
        this.store = (req) => __awaiter(this, void 0, void 0, function* () {
            return yield prisma.dir_payment_entries.createMany({
                data: (0, dirPaymentEntryValidation_1.multiRequestData)(req),
            });
        });
