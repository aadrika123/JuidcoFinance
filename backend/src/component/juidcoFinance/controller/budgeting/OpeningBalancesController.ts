...
class OpeningBalancesController {
  ...
  constructor() {
    ...
    this.initMsg = "OpeningBalances Entry";
  }
  ...
  create = async (
    ...
    try {
      const { error } = openingBalancesValidation.validate(req.body.data);
  ...
  update = async (
    ...
    try {
      const { error } = openingBalancesValidationWithID.validate(req.body.data);
