...
import InvestmentsController from "../../controller/budgeting/InvestmentsController";
...
class InvestmentsRoute {
    private controller: InvestmentsController;
    private baseUrl: string = `${baseUrl}/investments`;
    constructor(){
        this.controller = new InvestmentsController();
    }
