...
export const chequebookRequestData = (req: Request):  ChequebookRequestData=> {
  return {
    ...
    issuer_name: req.body.data.issuer_name,
    bank_id: req.body.data.bank_id,
    bank_account_no: req.body.data.bank_account_no,
    cheque_no_from: req.body.data.cheque_no_from,
    user_id: req.body.data.user_id,
    bank_branch: req.body.data.bank_branch,
    page_count: req.body.data.page_count,
    cheque_no_to: req.body.data.cheque_no_to,
